...
public final class AppUtils {
    ...
    public static final String USER_FNAME_STRING = "userFirstName";
    public static final String USER_LNAME_STRING = "userLastName";
    ...
    public static final String CURRENT_USER_UID_STRING = "UID";
    ...
    public static final String APP_MAIN_NAME = "Intellimind";
